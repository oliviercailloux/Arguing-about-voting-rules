...
* https://github.com/oliviercailloux/Arguing-about-voting-rules/raw/master/arguing.pdf[COMSOC-2016] version (featuring a more complete presentation of the algorithm, but omits some proofs)
